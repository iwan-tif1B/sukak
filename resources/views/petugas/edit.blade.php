        ...
        <div class="row vh-100">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('m-petugas.update',$data->id_petugas) }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row mb-3">
                            <label for="nama_petugas" class="col-sm-2 col-form-label">Nama Petugas</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" value="{{ $data->nama_petugas }}">
