                    ...
                    <div class="card text-dark bg-light mb-3">
                        ...
                        <div class="card-body">
                            <input type="search" id="searchInput"
                                placeholder="Cari pasien berdasrkan nama atau no rekam medis..." class="form-control">
                            <ul class="list-group list-group-flush mt-3" id="searchResults">

                            </ul>
                        </div>

                    </div>
                    <form action="{{ route('trx-registrasi.store') }}" method="post">
                        @csrf
                        <fieldset>
                            <legend>Data Pasien</legend>
                            <input type="hidden" name="id_pasien" value="0" id="id_pasien">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namapasien" name="nama_pasien" disabled>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="id_layanan">
                                        ...
                                        @foreach ($layanan as $index => $rows)
                                            <option value="{{ $rows->id_layanan }}">{{ $rows->nama_layanan }}</option>
                                        @endforeach
                    ...
                    success: function(data) {
                        ...
                        if (patients.length > 0) {
                            patients.forEach(function(patient) {
                                results.append(`<li class="list-group-item myitem additem" data-id="`+patient.id_pasien+`">
                                    <div class="row">
                                        <div class="col-sm-12">
